<script>
	...
	import CircleDecorations from '$lib/icons/CircleDecorations.svelte';
...
<section class="py-16 lg:py-24">
			...
			<TabList class="tab-list grid grid-cols-4 grid-rows-4 items-stretch gap-x-16">
				...
				{#each possibilities as possibility}
					...
					>
						...
						<Button class="mt-8" text="Schreibe uns" color="black" />
					</Tab>
				{/each}
			</TabList>
			<TabPanels>
		...
		<ul class="mt-16 lg:hidden">
			{#each possibilities as possibility}
				<li class="group mt-24 first:mt-0">
					...
					<Button class="group-odd:float-right" text="Schreibe uns" color="black" />
				</li>
			{/each}
		</ul>
	</div>
	...
	>
		...
		<div>
			...
			<Button class="mt-7" text="Schreibe uns" color="black" />
		</div>
	</div>
</section>
